...
== Changelog ==
= 3.2.2: April 30th, 2025 =
* Fix: Resolved an issue where bulk downloading PDF receipts was skipping renewal donations

= 3.2.1: May 15th, 2024 =
* Fix: Resolved conflict with WooCommerce and WP CLI

= 3.2.0: January 10th, 2024 =
* Happy new year!
* Fix: Resolved an internal server error issue with some sites using WPML + Form Field Manager + PDF Receipts
* New: Added PDF receipt form settings compatability for use with GiveWP 3.3.0

= 3.1.1: September 25th, 2023 =
* Fix: Downloading the PDF receipt file from forms that use the Fee Recovery add-on no longer produces an error

= 3.1.0: September 21st, 2023 =
* Feature: Added per-form settings to the visual donation form builder

= 3.0.0: September 14th, 2023 =
* Feature: Added compatibility with visual donation form builder

= 2.4.0: April 27th, 2023 =
* Feature: Admins can now generate a zip of all PDF receipts for a specific date range!
* Feature: Admins can now select multiple donations from the list table and generate a zip of all PDF receipts for those donations!
* Feature: Added a new written tags for writing out amounts in words
* Feature: Added a new {donor_comment} tag for displaying the donor's comment in the PDF receipt
* Fix: The {company_name} tag now works properly, instead of showing nothing

= 2.3.13: November 1st, 2021 =
* Fix: There was a compatibility issue with Form Field Manager 2.0.0. Now it's compatible!

= 2.3.12: September 16th, 2021 =
* Fix: Removed extra comma after zip code
